...
public class Notification {
    ...
    @Column(name="is_broadcast",nullable=false) @Builder.Default private Boolean isBroadcast=false;
    @Column(name="is_read",nullable=false) @Builder.Default private Boolean isRead=false;
    @Column(name="created_by",columnDefinition="VARCHAR(36)") private UUID createdBy;
